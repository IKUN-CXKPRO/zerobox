...
enum MassDataType {
  ...
  static MassDataType fromValue(int value) {
    return switch (value) {
      ...
      50 => MassDataType.notificationIcon,
      52 => MassDataType.music,
      53 => MassDataType.watchfaceFont,
      64 => MassDataType.thirdPartyApp,
      _ => throw ArgumentError('invalid MassDataType value: $value'),
    };
  }
}
...
class MassPacket {
  ...
  factory MassPacket.build(Uint8List fileData, MassDataType dataType) {
    return MassPacket(
      dataType: dataType,
      md5: _md5(fileData),
  ...
  Uint8List encodeWithCrc32({int sentLength = 0}) {
    ...
    _writeUint32LE(crcPayload, crc32Val);

    return crcPayload.toBytes();
  }

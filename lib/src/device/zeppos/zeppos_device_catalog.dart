  ...
  bool matches(String name) {
    ...
    for (final bluetoothName in bluetoothNames) {
      ...
      if (normalized.startsWith('$bluetoothName ') ||
        ...
        if (RegExp(r'^[A-Z0-9]{4}$', caseSensitive: false).hasMatch(suffix)) {
          return true;
        }
      }
    }
...
const zeppOsDeviceCatalog = <ZeppOsDeviceCatalogEntry>[
  ZeppOsDeviceCatalogEntry(id: 'helio-ring', bluetoothNames: ['Amazfit Helio Ring']),
  ZeppOsDeviceCatalogEntry(id: 'helio-strap', bluetoothNames: ['Amazfit Helio Strap']),
  ZeppOsDeviceCatalogEntry(id: 'active', bluetoothNames: ['Amazfit Active']),
  ZeppOsDeviceCatalogEntry(id: 'active-edge', bluetoothNames: ['Amazfit Active Edge']),
  ZeppOsDeviceCatalogEntry(id: 'active-max', bluetoothNames: ['Amazfit Active Max', 'Active Max']),
  ZeppOsDeviceCatalogEntry(id: 'active-2-nfc-round', bluetoothNames: ['Active 2 NFC (Round)']),
  ...
  ZeppOsDeviceCatalogEntry(
    id: 'active-2-square',
    bluetoothNames: ['Active 2 (Square)', 'Active 2 NFC (Square)', 'Active 2 Square', 'Active 2 NFC Square'],
    connectionCapability: ZeppOsConnectionCapability.both,
  ),
  ZeppOsDeviceCatalogEntry(
    id: 'active-3-premium',
  ...
  ZeppOsDeviceCatalogEntry(id: 'cheetah-pro', bluetoothNames: ['Amazfit Cheetah Pro']),
  ZeppOsDeviceCatalogEntry(id: 'cheetah-round', bluetoothNames: ['Amazfit Cheetah R']),
  ZeppOsDeviceCatalogEntry(id: 'cheetah-square', bluetoothNames: ['Amazfit Cheetah S']),
  ZeppOsDeviceCatalogEntry(
    id: 'cheetah-2-pro',
  ...
  ZeppOsDeviceCatalogEntry(id: 'gtr-3-pro', bluetoothNames: ['Amazfit GTR 3 Pro']),
  ZeppOsDeviceCatalogEntry(id: 'gtr-4', bluetoothNames: ['Amazfit GTR 4', 'Amazfit GTR 4 LE']),
  ZeppOsDeviceCatalogEntry(id: 'gtr-mini', bluetoothNames: ['Amazfit GTR Mini']),
  ...
  ZeppOsDeviceCatalogEntry(id: 'gts-4-mini', bluetoothNames: ['Amazfit GTS 4 Mini']),
  ZeppOsDeviceCatalogEntry(id: 'gts-4-mini-new', bluetoothNames: ['Amazfit GTS 4 mini New']),
  ...
  ZeppOsDeviceCatalogEntry(id: 'trex-3-pro-44', bluetoothNames: ['T-Rex 3 Pro (44mm)']),
  ZeppOsDeviceCatalogEntry(id: 'trex-3-pro-48', bluetoothNames: ['T-Rex 3 Pro (48mm)']),
  ZeppOsDeviceCatalogEntry(id: 'trex-ultra', bluetoothNames: ['Amazfit T-Rex Ultra']),
  ZeppOsDeviceCatalogEntry(id: 'trex-ultra-2', bluetoothNames: ['Amazfit T-Rex Ultra 2', 'T-Rex Ultra 2']),
];
